        ...
        >
          ...
          <div className="mb-4 relative">
            <input
              ...
              className={`w-full bg-gray-200 p-3 pr-10 rounded-xl text-sm focus:outline-none focus:ring-2 ${errors.username ? "focus:ring-red-500" : "focus:ring-green-500"
                }`}
            />
          ...
          <div className="mb-4 relative">
            <input
              ...
              className={`w-full bg-gray-200 p-3 pr-10 rounded-xl text-sm focus:outline-none focus:ring-2 ${errors.password ? "focus:ring-red-500" : "focus:ring-green-500"
                }`}
            />
