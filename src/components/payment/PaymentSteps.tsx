            ...
            <div className="flex items-center">
                {steps.map((s, index) => (
                    <div key={s.id} className="flex items-center">
                        <button
                            // DIUBAH: Logika disabled diperbarui
                            disabled={
                                s.id === 2 || // Tombol Langkah 2 selalu nonaktif
                                (s.id === 1 && step > 1) || // Tombol Langkah 1 nonaktif setelah lewat
                                (s.id === 3 && step !== 2)    // Tombol Langkah 3 hanya aktif saat di Langkah 2
                            }
                            ...
                            } disabled:opacity-50`} // DIUBAH: 'disabled:cursor-not-allowed' dihapus
                        >
                            {s.id}. {s.label}
                        </button>
