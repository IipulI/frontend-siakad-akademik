...
export default function App() {
  return (
    <Routes>
      ...
      <Route path={String(StudentRoute.payment.paymentDetailHistory)} element={<PaymentDetailTransaction />} />
      ...
      <Route path={String(AdminAcademicRoute.detailAnnouncement)} element={<DetailAnnouncement />} />
      ...
      <Route path={`${AdminAcademicRoute.courseManagement.editCourse}/:id`} element={<EditCourse />} />
