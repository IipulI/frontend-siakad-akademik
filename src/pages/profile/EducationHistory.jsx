  ...
  return (
    <RoundedBorderLayout className={"items-start gap-4 text-[#617182]"}>
      <div className="flex flex-col space-y-4 ">
        <InputField title={"Pendidikan Asal"} />
        <InputField title={"Provinsi Sekolah"} />
        <InputField title={"Kota/Kab Sekolah"} />
        <InputField title={"Sekolah"} />
        <InputField textArea={true} title={"Alamat sekolah"} />
      </div>
      <div className="flex flex-col space-y-4 ">
