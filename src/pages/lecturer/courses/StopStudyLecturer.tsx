...
import TableFinalProject from "../../../components/lecturer/TableFinalProject";
import { Pagination } from "../../../components/admin-academic/Pagination";
import TableLecturer from "../../../components/lecturer/TableLecturer";

const StopStudyLecturer = () => {
  const [id, setId] = useState<string | null>(null);
  const [currentPage, setCurrentPage] = useState(1);
  const [rowsPerPage, setRowsPerPage] = useState(10);

  const tableHead = ["Mahasiswa", "Periode", "Jenis Pengajuan", "Status Akademik", "Status", "Tagihan", "Aksi"]
...
export default StopStudyLecturer