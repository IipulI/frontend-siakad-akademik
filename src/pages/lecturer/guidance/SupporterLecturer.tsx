...
const SupporterLecturer = () => {
  ...
  const tableHead = ["Nilai", "Jenis", "Nama Kegiatan", "Unit", "Instansi", "Mulai", "Selesai", "Aksi"]
            ...
            <>
                <div className="w-full bg-white py-2 rounded-sm border-t-2 border-primary-yellow">
                    <div className="flex px-4 justify-between">
                        ...
                        <button className="bg-primary-blueSoft cursor-pointer text-white flex items-center rounded px-4 py-1">
