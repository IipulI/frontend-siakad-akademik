...
import { ITranscriptCourse } from "../../../types/mahasiswa/mahasiswa.types";
        ...
        <table className="min-w-full border border-gray-500">
          ...
          {courses.map((item, index) => (
              <tr key={item.kodeMataKuliah} className="text-center bg-gray-50">
                ...
                {/* --- Cell Added with Placeholder --- */}
                <td className="border border-gray-500 font-semibold px-4 py-2">-</td>
                <td className="border border-gray-500 font-semibold px-4 py-2">
                  {item.sks}
                </td>
                <td className="border border-gray-500 font-semibold px-4 py-2">
