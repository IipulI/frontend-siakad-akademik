            ...
            <div className="w-full bg-white py-4 rounded-sm border-t-2 border-primary-green px-5 relative">
                ...
                <div className="space-y-6">
                    ...
                    <div className="form-group flex items-center gap-4">
                        ...
                        <select name="mataKuliah" value={formData.mataKuliah} onChange={handleChange}
                                className="flex-1 p-2 border border-gray-300 rounded" required>
                    ...
                    <div className="form-group flex items-center gap-4">
                        ...
                        <input type="date" name="tanggalPenyusunan" value={formData.tanggalPenyusunan}
                               onChange={handleChange} className="flex-1 p-2 border border-gray-300 rounded" required/>
                    </div>
                    ...
                    <div className="form-group flex items-center gap-4">
                        ...
                        <select name="dosenPenyusun" value={formData.dosenPenyusun} onChange={handleChange}
                                className="flex-1 p-2 border border-gray-300 rounded" required>
                            <option value="" disabled>
                                -- Pilih Dosen --
                            </option>
                    ...
                    {[
                        ...
                        <div key={field.name} className="form-group flex items-start gap-4">
                            ...
                            <div className="flex-1">
                                <RichTextEditor name={field.name} value={formData[field.name]}
                    ...
                    <div className="form-group flex items-start gap-4 mb-4">
                        ...
                        <div className="flex flex-col flex-1">
                            ...
                            {formData.dokumenRps && <div
                                className="text-primary-green text-sm font-semibold mb-1">{formData.dokumenRps}</div>}

                            {/* Input file dengan border */}
                            <input id="dokumenRps" type="file" name="dokumenRps" accept=".pdf,.doc,.docx,.xls,.xlsx"
                                   onChange={handleFileChange} className="border border-gray-300 rounded px-3 py-2"/>

                            {/* Info format file */}
                            <p className="text-sm text-blue-500 mt-1">.pdf, .doc, .docx, .xls, .xlsx (maxsize: 10
                                MB)</p>
                        </div>
                    </div>
                </div>
