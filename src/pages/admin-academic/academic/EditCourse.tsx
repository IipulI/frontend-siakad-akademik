      ...
      <div className="w-full bg-white my-4 py-4 rounded-sm border-t-2 border-primary-green px-5">
        <div className="flex items-center justify-between mb-10">
          <div className="flex items-center ">
            ...
            <div className="flex items-center">
              <input type="search" placeholder="Cari Mata Kuliah" className="px-3 py-2 border border-black/50 rounded-l-md w-64" />
          ...
          <div className="flex gap-2">
            ...
            <button onClick={handleSave} className="bg-primary-green text-white px-4 py-2 rounded flex items-center">
